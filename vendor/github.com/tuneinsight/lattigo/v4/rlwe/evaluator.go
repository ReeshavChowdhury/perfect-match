...
type evaluatorBuffers struct {
	...
	// 0829: Add new buffers for Combined Rescale and Rotation.
	BuffPq *ring.Poly
}
...
func newEvaluatorBuffers(params Parameters) *evaluatorBuffers {
	...
	// 0829: Initialize newly added buffer:
	buff.BuffPq = ring.NewPoly(1<<params.logN, params.PCount()) // set level to levelP+1, the extra 1 is for ql (corresponding length is levelP+1+1)
